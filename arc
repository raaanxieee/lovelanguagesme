...
<head>
	...
	<meta charset="UTF-8" />
	<meta name="description" content="this your gifts">
    ...
    <meta property="og:description" content="Wish you a like this">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<img src="bannar.jpg" class="bannar">
			</div>
		</div>
		...
		<div class="row message">
			<div class="col-md-12">
				...
				<p>dan biarkan aku kasih ...></p>
				<p>sepotong kebahagiaan untukmu</p>
				<p>Saya membuat semua ini ...</p>
				<p>sebagai kado valentine untukmu</p>
				<p>terima kasih sudah ada didunia</p>
				<p>terima kasih untuk semua</p>
				<p>shizun berharap yang terbaik untukmu</p>
				<p>Semoga hidup Kamu nyaman</p>
				<p>Semoga semua harapan Kamu menjadi kenyataan</p>
				<p>Ingat</p>
				<p>ambisimu</p>
				<p>kamu harus hidup sebagai orang yang baik ...</p>
				<p>juga manis</p>
				<p>Sekarang situasinya berbeda ...</p>
				<p>kisah kamu selanjutnya</p>
				...
				<p>akhirnya...</p>
				<p>Shizun ingin mengucapkan satu kali lagi</p>
